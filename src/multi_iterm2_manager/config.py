...
class UiSettings:
    ...
    summary_title_max_chars: int = 12
...
def save_ui_settings(path_value: str, ui_settings: UiSettings) -> Path:
    ...
    existing.update({
        "ui": {
            ...
            "summary_title_max_chars": ui_settings.summary_title_max_chars,
...
def load_settings() -> Settings:
    ...
    summary_free_fallback_model = ui_settings.summary_free_fallback_model
    summary_title_max_chars = ui_settings.summary_title_max_chars or int(os.getenv("MITERM_SUMMARY_TITLE_MAX_CHARS", "12"))
    ...
    return Settings(
        ...
        summary_title_max_chars=summary_title_max_chars,
