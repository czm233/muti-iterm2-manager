...
class TerminalStateStore:
    ...
    def _record_to_dict(cls, record: TerminalRecord) -> dict[str, Any]:
        return {
            ...
            "summaryTitleAt": record.summary_title_at,
    ...
    def _record_from_dict(cls, data: dict[str, Any]) -> TerminalRecord | None:
        ...
        return TerminalRecord(
            ...
            summary_title=cls._str_value(data.get("summaryTitle")) or "",
            summary_title_at=cls._float_value(data.get("summaryTitleAt"), 0.0),
